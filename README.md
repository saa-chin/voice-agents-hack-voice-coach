...
- `./run-cli` — terminal voice/text chat against the local Gemma 4 model (use `--voice` for live audio).
- `./run-web` — FastAPI backend + Astro frontend in `web-py/` for the browser experience.
- `./run-tests` — Python + frontend test suites.
